...
warnings, and required manual actions before running 'kuma-migrator migrate'.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		target, err := migrator.ParseTargetVersion(planToLatest)
		if err != nil {
			return err
		}
		return migrator.Plan(planInputDir, planOutputDir, planMesh, target)
	},
}
...
func init() {
	...
	planCmd.Flags().StringVar(&planToLatest, "to-latest", "v2", toLatestFlagUsage)
